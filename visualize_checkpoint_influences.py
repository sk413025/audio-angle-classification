#!/usr/bin/env python
"""
Visualize per-checkpoint influence scores.
...
from tracin.utils.visualization import plot_influence_distribution
...
def main():
    ...
    # Parse arguments
    parser = argparse.ArgumentParser(description="Visualize per-checkpoint TracIn influence scores")
    ...
    # Generate visualizations for per-checkpoint influence scores
    title = "Distribution of Per-Checkpoint Influence Scores"
    plot_influence_distribution(
        metadata_file=args.metadata_file,
        save_path=os.path.join(args.output_dir, 'per_checkpoint_influence_distribution.png'),
        title=title
    )
